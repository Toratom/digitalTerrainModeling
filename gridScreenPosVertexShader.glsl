...
layout(location = 4) in vec2 vGridPos; //Le (i,j) normaliser c'est à dire diviser par la hauteur et la largeur respectivement
...
void main() {
    ...
    fColor.x = vGridPos.x; //X correspond à I et Y a J
    fColor.y = vGridPos.y;
}
